defmodule CuekooApi.UsersTest do
  ...
  describe "users" do
    ...
    import CuekooApi.UsersFixtures

    @invalid_attrs %{name: nil, address: nil, password: nil, email: nil, hashed_password: nil, confirmed_at: nil}
